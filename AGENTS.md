...
- Use TypeScript for the backend and frontend.
- Use Express, PostgreSQL, Prisma, JWT, and bcrypt.
- Use React, Vite, and Tailwind CSS for the frontend.
- Follow Red-Green-Refactor TDD, especially for backend logic.
...
- Run the relevant focused tests during development.
